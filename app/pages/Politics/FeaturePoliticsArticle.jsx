...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeaturePoliticsArticle"));
  const data = [];
...
export default function FeaturePoliticsArticle() {
...
<Link href={`Politics/FeaturePoliticsDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
