...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlinePoliticsArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlinePoliticsArticle', id);
  try {
...
export default async function HeadlinePoliticsDetails({params}) {
