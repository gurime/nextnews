...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureEducationArticle"));
  const data = [];
...
export default function FeatureEducationArticle() {
...
<Link href={`Education/FeatureEducationDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
