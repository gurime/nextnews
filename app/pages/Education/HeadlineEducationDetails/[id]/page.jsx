...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineEducationArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineEducationArticle', id);
  try {
...
export default async function HeadlineEducationDetails({params}) {
