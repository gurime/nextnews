...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureEducationArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureEducationArticle', id);
  try {
...
export default async function FeatureEducationDetails({params}) {
