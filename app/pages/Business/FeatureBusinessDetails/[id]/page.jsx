...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureBusinessArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureBusinessArticle', id);
  try {
...
export default async function FeatureBusinessDetails({params}) {
