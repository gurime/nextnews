...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineBusinessArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineBusinessArticle', id);
  try {
...
export default async function HeadlineBusinessDetails({params}) {
