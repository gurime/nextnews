...
const querySnapshot = await getDocs(collection(db, "HeadlineBusinessArticle"));
const data = [];
...
export default function HeadlineBusinessArticle() {
...
<Link href={`Business/HeadlineBusinessDetails/${blog.id}`}className="slugbtn btn">
