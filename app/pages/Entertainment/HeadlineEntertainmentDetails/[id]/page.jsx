...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineEntertainmentArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineEntertainmentArticle', id);
  try {
...
export default async function HeadlineEntertainmentDetails({params}) {
