...
const querySnapshot = await getDocs(collection(db, "HeadlineEntertainmentArticle"));
const data = [];
...
export default function HeadlineEntertainmentArticle() {
...
padding: '0 1rem'
}}>headline entertainment news</h1>
...
<Link href={`Entertainment/HeadlineEntertainmentDetails/${blog.id}`}className="slugbtn btn">
