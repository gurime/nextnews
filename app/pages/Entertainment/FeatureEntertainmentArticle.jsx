...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureEntertainmentArticle"));
  const data = [];
...
export default function FeatureEntertainmentArticle() {
...
<Link href={`Entertainment/FeatureEntertainmentDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
