...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureEntertainmentArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureEntertainmentArticle', id);
  try {
...
export default async function FeatureEntertainmentDetails({params}) {
