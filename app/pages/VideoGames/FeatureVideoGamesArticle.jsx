...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureVideoGamesArticle"));
  const data = [];
...
export default function FeatureVideoGamesArticle() {
...
<Link href={`VideoGames/FeatureVideoGamesDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
