...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureVideoGamesArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureVideoGamesArticle', id);
  try {
...
export default async function FeatureVideoGamesDetails({params}) {
