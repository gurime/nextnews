...
const querySnapshot = await getDocs(collection(db, "HeadlineVideoGamesArticle"));
const data = [];
...
export default function HeadlineVideoGamesArticle() {
...
<Link href={`VideoGames/HeadlineVideoGamesDetails/${blog.id}`}className="slugbtn btn">
