...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineVideoGamesArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineVideoGamesArticle', id);
  try {
...
export default async function HeadlineVideoGamesDetails({params}) {
