...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureMilitaryArticle"));
  const data = [];
...
export default function FeatureMilitaryArticle() {
...
<Link href={`Military/FeatureMilitaryDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
