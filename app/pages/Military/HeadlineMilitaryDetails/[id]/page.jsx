...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineMilitaryArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineMilitaryArticle', id);
  try {
...
export default async function HeadlineMilitaryDetails({params}) {
