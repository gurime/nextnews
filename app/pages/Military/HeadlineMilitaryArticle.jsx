...
const querySnapshot = await getDocs(collection(db, "HeadlineMilitaryArticle"));
const data = [];
...
export default function HeadlineMilitaryArticle() {
...
<Link href={`Military/HeadlineMilitaryDetails/${blog.id}`}className="slugbtn btn">
