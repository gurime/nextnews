...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureMilitaryArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureMilitaryArticle', id);
  try {
...
export default async function FeatureMilitaryDetails({params}) {
