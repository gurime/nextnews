...
const querySnapshot = await getDocs(collection(db, "HeadlineImmigrationArticle"));
const data = [];
...
export default function HeadlineImmigrationArticle() {
...
<Link href={`Immigration/HeadlineImmigrationDetails/${blog.id}`}className="slugbtn btn">
