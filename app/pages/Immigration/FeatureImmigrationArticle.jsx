...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureImmigrationArticle"));
  const data = [];
...
export default function FeatureImmigrationArticle() {
...
<Link href={`Immigration/FeatureImmigrationDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
