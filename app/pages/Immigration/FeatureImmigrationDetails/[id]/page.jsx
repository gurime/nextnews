...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureImmigrationArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureImmigrationArticle', id);
  try {
...
export default async function FeatureImmigrationDetails({params}) {
