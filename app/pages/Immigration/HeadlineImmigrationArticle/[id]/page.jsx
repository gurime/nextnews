...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineImmigrationArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineImmigrationArticle', id);
  try {
...
export default async function HeadlineImmigrationDetails({params}) {
