...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineOpinionArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineOpinionArticle', id);
  try {
...
export default async function HeadlineOpinionDetails({params}) {
