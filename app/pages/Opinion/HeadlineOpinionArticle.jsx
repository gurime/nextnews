...
const querySnapshot = await getDocs(collection(db, "HeadlineOpinionArticle"));
const data = [];
...
export default function HeadlineOpinionArticle() {
...
<Link href={`Opinion/HeadlineOpinionDetails/${blog.id}`}className="slugbtn btn">
