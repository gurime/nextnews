...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureOpinionArticle"));
  const data = [];
...
export default function FeatureOpinionArticle() {
...
<Link href={`Opinion/FeatureOpinionDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
