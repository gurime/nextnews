...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureOpinionArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureOpinionArticle', id);
  try {
...
export default async function FeatureOpinionDetails({params}) {
