...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureSportsArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureSportsArticle', id);
  try {
...
export default async function FeatureSportsDetails({params}) {
