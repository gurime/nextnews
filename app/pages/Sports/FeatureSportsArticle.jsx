...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureSportsArticle"));
  const data = [];
...
export default function FeatureSportsArticle() {
...
<Link href={`Sports/FeatureSportsDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
