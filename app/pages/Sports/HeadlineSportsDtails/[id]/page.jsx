...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineSportsArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineSportsArticle', id);
  try {
...
export default async function HeadlineSportsDetails({params}) {
