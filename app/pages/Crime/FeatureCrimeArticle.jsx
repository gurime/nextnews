...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureCrimeArticle"));
  const data = [];
...
export default function FeatureCrimeArticle() {
...
<Link href={`Crime/FeatureCrimeDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
