...
const querySnapshot = await getDocs(collection(db, "HeadlineCrimeArticle"));
const data = [];
...
export default function HeadlineCrimeArticle() {
...
<Link href={`Crime/HeadlineCrimeDetails/${blog.id}`}className="slugbtn btn">
