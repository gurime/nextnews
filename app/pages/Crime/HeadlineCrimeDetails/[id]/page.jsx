...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineCrimeArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineCrimeArticle', id);
  try {
...
export default async function HeadlineCrimeDetails({params}) {
