...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureCrimeArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureCrimeArticle', id);
  try {
...
export default async function FeatureCrimeDetails({params}) {
