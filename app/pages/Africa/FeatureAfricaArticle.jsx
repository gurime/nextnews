...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureAfricaArticle"));
  const data = [];
...
export default function FeatureAfricaArticle() {
...
<Link href={`Africa/FeatureAfricaDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
