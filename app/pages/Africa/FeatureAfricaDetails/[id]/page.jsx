...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureAfricaArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureAfricaArticle', id);
  try {
...
export default async function FeatureAfricaDetails({params}) {
