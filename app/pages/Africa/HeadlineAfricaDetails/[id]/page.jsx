...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineAfricaArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineAfricaArticle', id);
  try {
...
export default async function HeadlineAfricaDetails({params}) {
