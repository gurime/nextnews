...
const querySnapshot = await getDocs(collection(db, "HeadlineAfricaArticle"));
const data = [];
...
export default function HeadlineAfricaArticle() {
...
<Link href={`Africa/HeadlineAfricaDetails/${blog.id}`}className="slugbtn btn">
