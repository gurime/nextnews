...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineEconomyArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineEconomyArticle', id);
  try {
...
export default async function HeadlineEconomyDetails({params}) {
