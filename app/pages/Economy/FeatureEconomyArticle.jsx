...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureEconomyArticle"));
  const data = [];
...
export default function FeatureEconomyArticle() {
...
<Link href={`Economy/FeatureEconomyDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
