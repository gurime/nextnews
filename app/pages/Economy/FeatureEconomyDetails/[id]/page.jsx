...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureEconomyArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureEconomyArticle', id);
  try {
...
export default async function FeatureEconomyDetails({params}) {
