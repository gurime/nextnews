...
const querySnapshot = await getDocs(collection(db, "HeadlineEconomyArticle"));
const data = [];
...
export default function HeadlineEconomyArticle() {
...
<Link href={`Economy/HeadlineEconomyDetails/${blog.id}`}className="slugbtn btn">
