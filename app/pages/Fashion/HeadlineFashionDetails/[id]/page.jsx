...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineFashionArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineFashionArticle', id);
  try {
...
export default async function HeadlineFashionDetails({params}) {
