...
const querySnapshot = await getDocs(collection(db, "HeadlineFashionArticle"));
const data = [];
...
export default function HeadlineFashionArticle() {
...
<Link href={`Fashion/HeadlineFashionDetails/${blog.id}`}className="slugbtn btn">
