...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureFashionArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureFashionArticle', id);
  try {
...
export default async function FeatureFashionDetails({params}) {
