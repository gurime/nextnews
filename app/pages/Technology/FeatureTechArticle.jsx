...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureTechArticle"));
  const data = [];
...
export default function FeatureTechArticle() {
...
<Link href={`Technology/FeatureTechDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
