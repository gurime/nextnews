...
async function getArticles() {
  const querySnapshot = await getDocs(collection(db , "FeatureMusicArticle"));
  const data = [];
...
export default function FeatureMusicArticle() {
...
<Link href={`Music/FeatureMusicDetails/${post.id}`}className="hero-btn">
Read More
</Link>
{post.date}
</div>
