...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'HeadlineMusicArticle', params.id);
  ...
  const articleRef = doc(db, 'HeadlineMusicArticle', id);
  try {
...
export default async function HeadlineMusicDetails({params}) {
