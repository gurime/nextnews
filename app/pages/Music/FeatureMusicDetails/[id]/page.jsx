...
export async function generateMetadata({ params }) {
  ...
  const docRef = doc(db, 'FeatureMusicArticle', params.id);
  ...
  const articleRef = doc(db, 'FeatureMusicArticle', id);
  try {
...
export default async function FeatureMusicDetails({params}) {
