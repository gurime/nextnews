...
const querySnapshot = await getDocs(collection(db, "HeadlineMusicArticle"));
const data = [];
...
export default function HeadlineMusicArticle() {
...
<Link href={`Music/HeadlineMusicDetails/${blog.id}`}className="slugbtn btn">
